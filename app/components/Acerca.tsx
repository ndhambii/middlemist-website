...
const Hero = () => {
  return (
    <main>
      ...
      >
        <div className="flex items-center justify-center border border-pink-300 shadow-lg rounded-xl bg-[#dca38e]/80">
          <Image
            src="/wax.png"
        ...
        <h1 className="md:text-center md:text-6xl text-4xl font-bold mb-2 mx-2 mt-5">
          ...
          {"   "}
          to... <br />
          <span className="px-6 text-white bg-gradient-to-r from-[#ecac99] to-[#dca38e] rounded-sm ">
            MiddleMist
          </span>
        </h1>
        <p className="mx-2 font-bold text-lg text-[#f7e4d9] md:text-center mb-4">
          Depilação Feminina à Cera em Maputo
        </p>
        <div className="cursor-pointer w-fit mx-auto bg-gradient-to-r from-pink-400 to-pink-600 text-white  py-2 px-6 rounded-full flex items-center shadow-lg md:text-3xl xl:shadow-none hover:shadow-lg hover:bg-gradient-to-r hover:from-pink-600 hover:to-pink-400 active:bg-gradient-to-r active:from-pink-800 active:to-pink-600 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-pink-300">
